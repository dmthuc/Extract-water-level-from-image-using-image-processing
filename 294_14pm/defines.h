...
const double ANN_THRESHOLDS = -3.5e7;
...
/*define ratio between side of rectangle*/
const double SIDE_RATIO = 0.3;
/*define threshold of output of ANN*/
const double ANN_THRESHOLD = -1.9e9;
#endif
